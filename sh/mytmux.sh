...
if [ $? != 0 ]
then
    tmux new-session -s dev -n "$ver" -d
    ...
    tmux send-keys -t dev:0.2 'echo "octopusengine[dot]com is a community of Makers" | pv -qL 10' C-m 'python3 $HOME/mysh/octopus.py' C-m
